                            ...
                            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white dark:bg-black dark:bg-opacity-90 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6 max-h-[90vh] overflow-y-auto">
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            <label className="text-xs text-gray-500 dark:text-gray-400 mb-1 block">Street Address:</label>
                                            <input
                                                className="w-full text-xs border-gray-300 rounded dark:bg-black dark:text-white dark:border-0"
                                                type="text"
                                                name="street"
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                <label className="text-xs text-gray-500 dark:text-gray-400 mb-1 block">Zip:</label>
                                                <input
                                                    className="w-full text-xs border-gray-300 rounded dark:bg-black dark:text-white dark:border-0"
                                                    type="text"
                                                    name="zip"
                                        ...
                                        <div>
                                            <label className="text-xs text-gray-500 dark:text-gray-400 mb-1 block">Domain:</label>
                                            <select
                                                className="w-full text-xs border-gray-300 rounded dark:bg-black dark:text-white dark:border-0"
                                                name="service"
                                        ...
                                        <div>
                                            <label className="text-xs text-gray-500 dark:text-gray-400 mb-1 block">URL:</label>
                                            <input
                                                className="w-full text-xs border-gray-300 rounded dark:bg-black dark:text-white dark:border-0"
                                                type="text"
                                                name="url"
                                        ...
                                        <div>
                                            <label className="text-xs text-gray-500 dark:text-gray-400 mb-1 block">Requirements (separate by comma):</label>
                                            <input
                                                className="w-full text-xs border-gray-300 rounded dark:bg-black dark:text-white dark:border-0"
                                                type="text"
                                                name="requirements"
                                        ...
                                        <div>
                                            <label className="text-xs text-gray-500 dark:text-gray-400 mb-1 block">Needs to bring (separate by comma):</label>
                                            <input
                                                className="w-full text-xs border-gray-300 rounded dark:bg-black dark:text-white dark:border-0"
                                                type="text"
                                                name="needs"
