...
function AssignedCoach({
  ...
  return (
    <div className={`rounded-full text-xs font-extralight shadow`}>
      ...
      >
        <div className={`bg-green-100 flex-grow px-4 py-2 text-black truncate`}>
          {coach.email}
        </div>
        <div
          className={`bg-red-500 px-4 py-2 flex items-center cursor-pointer`}
      ...
      >
        ...
        <div
          className={`bg-red-500 flex-1 px-4 py-2 text-center text-white cursor-pointer`}
          onClick={removeCoach}
        >
          Confirm
        </div>
