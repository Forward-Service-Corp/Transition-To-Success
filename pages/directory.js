      ...
      >
        ...
        >
          <div className={""}>
            ...
            <input
              className={
                "w-full rounded border-gray-300 text-xs dark:bg-black dark:text-white dark:border-0 dark:placeholder:text-gray-500"
              }
          ...
          <div className={"flex items-center"}>
            <button
              type={"submit"}
              className={
                "py-[8px] px-6 mr-2 text-white  text-xs bg-blue-500 hover:bg-blue-600 disabled:bg-gray-400 dark:rounded-lg"
              }
              disabled={
                keyword === "" && domain === "none" && county === "none"
              }
              onClick={() => {
                setSearched(true);
              }}
